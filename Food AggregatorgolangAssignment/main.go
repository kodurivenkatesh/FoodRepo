...
const Fruit_suplier_Url = "https://run.mocky.io/v3/c51441de-5c1a-4dc2-a44e-aab4f619926b"
const Grain_Suplier_Url = "https://run.mocky.io/v3/e6c77e5c-aec9-403f-821b-e14114220148"
const Vegetable_supiler_Url = "https://run.mocky.io/v3/4ec58fbc-e9e5-4ace-9ff0-4e893ef9663c"
...
func Getbyname(w http.ResponseWriter, r *http.Request) {
	...
	response, err1 := http.Get(Vegetable_supiler_Url)
	if err1 != nil {
		panic(err1)
	}
	...
	response1, er := http.Get(Fruit_suplier_Url)
	if er != nil {
		panic(er)
	}
	...
	response2, er := http.Get(Grain_Suplier_Url)
	if er != nil {
		panic(er)
	}
